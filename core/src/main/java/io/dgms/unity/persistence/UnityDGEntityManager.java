...
package io.dgms.unity.persistence;
 ...
 *
 */
public class UnityDGEntityManager implements AutoCloseable, EntityManager
{
    /**
     *
     */
     ...
     * @param em
     */
    public UnityDGEntityManager(final EntityManager em)
    {
        this.em = em;
    }
