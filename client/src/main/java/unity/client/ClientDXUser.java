 ...
 *
 */
public class ClientDXUser extends ClientDXSessionObject implements DXUser
{
    /**
     *
     */
     ...
     * @param object
     */
    public ClientDXUser(ClientDXSession session, User object)
    {
        super(session);
        this.object = object;
    }
     ...
     */
    @Override
    public ClientDXProject getProject(String path) throws DXException
    {
     ...
     */
    @Override
    public Stream<ClientDXProject> getProjects() throws DXException
    {
        try {
            return api().getProjectApi().getProjects().stream()
                    .flatMap(p -> Stream.of(new ClientDXProject(getSession(), p)));
