 ...
 *
 */
public class ClientDXProject extends ClientDXSessionObject implements DXProject
{
    /**
     *
     */
     ...
     * @param object
     */
    public ClientDXProject(ClientDXSession session, Project object)
    {
        super(session);
        this.object = object;
    }
    ...
    {
        return new ClientDXRepository(getSession(), this);
    }
     ...
     */
    @Override
    public ClientDXWorkspace getWorkspace()
    {
        // TODO Auto-generated method stub
        return null;
    }
