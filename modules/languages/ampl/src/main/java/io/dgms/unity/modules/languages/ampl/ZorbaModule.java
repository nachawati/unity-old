...
package io.dgms.unity.modules.languages.ampl;
...
public class ZorbaModule
{
     ...
     * @return
     */
    public static ItemSequence solve(Zorba zorba, DGScriptContext context, ItemSequence model, ItemSequence solver)
    {
        final Environment env = new Environment(DGSystem.getInstallPath().resolve("bin").toAbsolutePath().toString());
