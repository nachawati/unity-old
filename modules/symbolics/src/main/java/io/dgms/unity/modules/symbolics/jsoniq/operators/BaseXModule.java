...
package io.dgms.unity.modules.symbolics.jsoniq.operators;
...
public class BaseXModule
{
    ...
    @Deterministic
    @Requires(Permission.READ)
    public Object conditional(Object arg1, Object arg2, Object arg3)
    {
        if (!(arg1 instanceof Expr))
            throw new RuntimeException();
    ...
    @Deterministic
    @Requires(Permission.READ)
    public Object equal(Object arg1, Object arg2)
    {
        if (arg1 instanceof Expr) {
            if (arg2 instanceof Expr)
    ...
    @Deterministic
    @Requires(Permission.READ)
    public Object greater_than(Object arg1, Object arg2)
    {
        if (arg1 instanceof Expr) {
            if (arg2 instanceof Expr)
    ...
    @Deterministic
    @Requires(Permission.READ)
    public Object greater_than_or_equal(Object arg1, Object arg2)
    {
        if (arg1 instanceof Expr) {
            if (arg2 instanceof Expr)
    ...
    @Deterministic
    @Requires(Permission.READ)
    public Object integer_divide(Object arg1, Object arg2)
    {
        if (arg1 instanceof Expr) {
            if (arg2 instanceof Expr)
                return ((Expr) arg1).divide((Expr) arg2);
    ...
    @Deterministic
    @Requires(Permission.READ)
    public boolean isJavaType(Value arg)
    {
        return false;
    }
    ...
    @Deterministic
    @Requires(Permission.READ)
    public Object less_than(Object arg1, Object arg2)
    {
        if (arg1 instanceof Expr) {
            if (arg2 instanceof Expr)
    ...
    @Deterministic
    @Requires(Permission.READ)
    public Object less_than_or_equal(Object arg1, Object arg2)
    {
        if (arg1 instanceof Expr) {
            if (arg2 instanceof Expr)
    ...
    @Deterministic
    @Requires(Permission.READ)
    public Object not_equal(Object arg1, Object arg2)
    {
        if (arg1 instanceof Expr) {
            if (arg2 instanceof Expr)
    ...
    @Deterministic
    @Requires(Permission.READ)
    public Object unary_minus(Object arg)
    {
