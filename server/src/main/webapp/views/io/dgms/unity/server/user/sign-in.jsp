...
<link rel="stylesheet" href="${contextPath}/assets/bower_components/bootstrap/dist/css/bootstrap.min.css">
<link rel="stylesheet" href="${contextPath}/assets/bower_components/font-awesome/css/font-awesome.min.css">
<link rel="stylesheet" href="${contextPath}/assets/bower_components/Ionicons/css/ionicons.min.css">
<link rel="stylesheet" href="${contextPath}/assets/bower_components/admin-lte/dist/css/AdminLTE.min.css">
<link rel="stylesheet" href="${contextPath}/assets/bower_components/admin-lte/plugins/iCheck/square/blue.css">
<!--[if lt IE 9]>
...
<body class="hold-transition login-page">
	<div class="login-box">
		...
		<div class="login-box-body">
			...
			<form action="${contextPath}/users/sign-in" method="post">
	...
	<script src="${contextPath}/assets/bower_components/admin-lte/plugins/iCheck/icheck.min.js"></script>
	<script>
		$(function() {
			$('input').iCheck({
